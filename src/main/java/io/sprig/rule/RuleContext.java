...
/**
 * Everything a rule needs to make its decision. One of {@code spring} or
 * {@code config} may be {@code null} when the scanned project has no Java
 * sources or no configuration files respectively.
 *
