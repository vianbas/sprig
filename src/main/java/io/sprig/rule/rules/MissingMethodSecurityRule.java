...
/**
 * SPR-SRC-004 — {@code @EnableWebSecurity} is used together with method security annotations
...
public final class MissingMethodSecurityRule implements Rule {
    ...
    public void analyze(RuleContext ctx, FindingCollector findings) {
        ...
        boolean usesMethodAnnotations =
                spring.usesAnnotation(PRE_AUTHORIZE)
        ...
        boolean methodSecurityEnabled =
                spring.usesAnnotation(ENABLE_METHOD_SECURITY)
