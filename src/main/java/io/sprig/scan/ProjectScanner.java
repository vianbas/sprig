...
/**
 * Walks a project directory and collects Java sources plus Spring configuration files. Directory
 * names that are always build/ignored output are skipped entirely.
 */
                        ...
                        public FileVisitResult preVisitDirectory(
                            ...
                            if (!dir.equals(root)) {
                                ...
                                if (SKIP_DIRS.contains(name)
                                        || matchesAny(excludes, root.relativize(dir))) {
