...
/**
 * Parses Java sources with a per-instance {@link JavaParser} (never the
 * static one, whose global configuration is mutable and racy). Files that fail
 * to parse are skipped and counted — a linter must never crash on a target
 * project.
 */
