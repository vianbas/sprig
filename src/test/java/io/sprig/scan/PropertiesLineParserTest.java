...
class PropertiesLineParserTest {
    ...
    void parsesKeyValuePairsWithLineNumbers() {
        ...
        Map<String, ConfigEntry> map =
                PropertiesLineParser.parseContent(props, Path.of("application.properties"));

        assertThat(map.get("server.port").asString()).isEqualTo("8080");
        assertThat(map.get("server.port").line()).isEqualTo(1);
        assertThat(map.get("spring.datasource.url").asString())
    ...
    void handlesContinuationLines() {
        ...
        Map<String, ConfigEntry> map =
                PropertiesLineParser.parseContent(props, Path.of("a.properties"));
